...
/// <summary>
/// Solicitação para criação de um plano.
/// </summary>
...
/// <param name="IsCustomPricing">Indica se o plano terá preço customizado.</param>
/// <param name="IsActive">Indica se o plano inicia ativo.</param>
